...
export const allProducts = [
  ...
  },
  {
    ...
    description: "Comprehensive pose reference application for artists and designers.",
    image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=400&h=300&fit=crop",
    category: "Standalone Apps",
    detailedDescription: "Amlo Pose provides an extensive library of pose references for artists, illustrators, and animators. With thousands of high-quality poses, customizable angles, and real-time 3D models, you'll never struggle with anatomy or positioning again. Perfect for character design and figure drawing.",
    features: ["3D Pose Library", "Custom Angles", "Anatomy Reference", "Export Options", "Offline Access"],
    detailedImage: "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&h=600&fit=crop",
    downloadButtons: [
      { text: "Download Windows", url: "https://lynk.id/pixelas.cloud/mq7on743wrqq" },
      { text: "Download Mac", url: "https://lynk.id/pixelas.cloud/mq7on743wrqq" }
    ],
  ...
  },
  {
    ...
    features: ["Instant Capture", "Smart Annotations", "Auto-Blur Sensitive Data", "Cloud Upload", "Hotkey Support"],
    detailedImage: "https://images.unsplash.com/photo-1558655146-9f40138edfeb?w=800&h=600&fit=crop",
    downloadButtons: [
      { text: "Download Windows", url: "https://lynk.id/pixelas.cloud/mq7on743wrqq" },
      { text: "Download Mac", url: "https://lynk.id/pixelas.cloud/mq7on743wrqq" }
    ],
  ...
  },
  {
    ...
    features: ["AI Skin Retouching", "Blemish Removal", "Color Correction", "Batch Actions", "Photoshop 2024 Compatible"],
    detailedImage: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&h=600&fit=crop",
    downloadButtons: [
  ...
  },
  {
    ...
    features: ["AI Background Removal", "Style Transfer", "Smart Object Selection", "Generative Fill", "Real-time Preview"],
    detailedImage: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=600&fit=crop",
    downloadButtons: [
  ...
  },
  {
    ...
    features: ["10x Faster Processing", "GPU Acceleration", "Batch Support", "Low Memory Usage", "Real-time Preview"],
    detailedImage: "https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=800&h=600&fit=crop",
    downloadButtons: [
      { text: "Download Plugin", url: "https://lynk.id/pixelas.cloud/mq7on743wrqq" },
  ...
  },
  {
    ...
    features: ["DirectX Acceleration", "Windows Integration", "Touch Screen Support", "4K Display Optimized", "Lifetime Updates"],
    detailedImage: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&h=600&fit=crop",
    downloadButtons: [
      { text: "Download Windows", url: "https://lynk.id/pixelas.cloud/mq7on743wrqq" },
